...
('Auriculares Pro', 'Auriculares Bluetooth con cancelación de ruido activa, 30 horas de bateria y sonido Hi-Fi premium.', 149.99, 25, 'Electrónica', 'https://images.unsplash.com/photo-1505740420928-5e560c06d30e?w=400&h=400&fit=crop', NOW(), NOW()),
...
('Camara Digital Mirrorless', 'Camara sin espejo de 24MP con grabación 4K, estabilización de imagen y WiFi integrado.', 899.99, 8, 'Fotografía', 'https://images.unsplash.com/photo-1516035069371-29a1b244cc32?w=400&h=400&fit=crop', NOW(), NOW()),
...
('Webcam 4K Streaming', 'Camara web 4K con micrófono dual, corrección de luz automatica y ángulo de 90°.', 169.99, 22, 'Streaming', 'https://images.unsplash.com/photo-1587826080692-f439cd0b70da?w=400&h=400&fit=crop', NOW(), NOW());
